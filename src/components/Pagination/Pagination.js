...
const Pagination = ({ currentPage, pagesCount, setCurrentPage }) => {
  ...
  const pageCounter = () => {
    ...
    if (pagesCount <= maxCountOfPage || currentPage <= midleOfNumeration) {
      ...
      let startCounting = currentPage - midleOfNumeration;
      let  endCounting = currentPage + midleOfNumeration;
      if (endCounting >= pagesCount) {
        startCounting = pagesCount - maxCountOfPage + 1;
        endCounting = pagesCount;
      }
